...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b0t3rji.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b0t3rji.containers.anotherwebservice.com/
...
```
git clone git@github.com:MasalaOats/container-b0t3rji.git
cd container-b0t3rji
```
...
```
docker attach container-b0t3rji
```
